...
public class PvpTeam implements Loggable {
    ...
    private static String teamError(User user, Guild guild, String character) {
        ...
        .addActionRow(Button.secondary("Pvp::teamErrorName::"+guild.getId(), "Edit name"), Button.secondary("Pvp::teamErrorServer::"+guild.getId(), "Edit server"), Button.danger("Pvp::teamErrorRemove::"+guild.getId(), "Remove me"))
        .queue();
